    ...
    return (
        <>
            <div className="box-border md:box-content  border-2 p-3">
                ...
                ) : isBalanceLoading ? (< h2 className="m-auto  font-center font-small leading-small mt-0 mb-2 text-black-800">
                    Updating Wallet 😀
                </h2>) : (< h2 className="m-auto  font-center font-small leading-small mt-0 mb-2 text-black-800">
                    Amount :   ₹ {data?.amount}
                </h2>)}
            </div>
